...
import * as $proxy from "./routes/proxy.ts";
...
import * as $MultiStepForm from "./islands/MultiStepForm.tsx";
...
const manifest = {
  ...
  islands: {
    ...
    "./islands/MultiStepForm.tsx": $MultiStepForm,
